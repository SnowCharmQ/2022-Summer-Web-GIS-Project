...
public class PictureUtil {
     ...
     */
    public static void compressPictureByScale(String inputPath, float scale, float outputQuality, String outputPath) throws IOException{
        Thumbnails.of(inputPath).scale(scale).outputQuality(outputQuality).toFile(outputPath);
    }
